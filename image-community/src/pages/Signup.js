...
const Signup = (props) => {
  ...
  <SignupPage>
    ...
    <Input type="password" width="300px" margin="10px 0" label="비밀번호" placeholder="비밀번호를 입력해주세요."/>
    <Input type="password" width="300px" margin="10px 0" label="비밀번호 확인" placeholder="비밀번호를 한 번 더 입력해주세요."/>
    <Button margin="10px 110px">가입하기</Button>
    </Grid>    
    </SignupBox>
  </SignupPage>
  </>
